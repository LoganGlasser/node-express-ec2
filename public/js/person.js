document.addEventListener('DOMContentLoaded', () => {   //makign sure all of the DOM is loaded
    ...
    // Check if the button with ID "DYOAButton" exists before adding event listener
    const DYOAButton = document.getElementById("DYOAButton");
    if (DYOAButton) {
        DYOAButton.addEventListener("click", function() {
            const baseURL = window.location.protocol + '//' + window.location.host;
    ...
    // Check if the button with ID "DYOABButton" exists before adding event listener
    const DYOABButton = document.getElementById("DYOABButton");
    if (DYOABButton) {
        DYOABButton.addEventListener("click", function() {
            const baseURL = window.location.protocol + '//' + window.location.host;
